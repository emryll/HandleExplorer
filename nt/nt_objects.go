...
func GetDomainFromObject(objType uint32) uint8 {
	...
	case OBJ_TYPE_PROCESS:
		domain = utils.DOMAIN_PROCESS
	case OBJ_TYPE_THREAD:
		domain = utils.DOMAIN_THREAD
	case OBJ_TYPE_EVENT:
		domain = utils.DOMAIN_EVENT
	case OBJ_TYPE_MUTANT:
		domain = utils.DOMAIN_MUTEX
	case OBJ_TYPE_TIMER, OBJ_TYPE_IRTIMER:
		domain = utils.DOMAIN_TIMER
	case OBJ_TYPE_SEMAPHORE:
		domain = utils.DOMAIN_SEMAPHORE
	case OBJ_TYPE_SECTION:
		domain = utils.DOMAIN_SECTION
	case OBJ_TYPE_FILE:
		domain = utils.DOMAIN_FILE
	case OBJ_TYPE_PIPE:
		domain = utils.DOMAIN_PIPE
	case OBJ_TYPE_JOB:
		domain = utils.DOMAIN_JOB
	case OBJ_TYPE_KEY:
		domain = utils.DOMAIN_KEY
	case OBJ_TYPE_TOKEN:
		domain = utils.DOMAIN_TOKEN
	case OBJ_TYPE_DESKTOP:
		domain = utils.DOMAIN_DESKTOP
	default:
		domain = utils.DOMAIN_GLOBAL
	}
	return domain
}
